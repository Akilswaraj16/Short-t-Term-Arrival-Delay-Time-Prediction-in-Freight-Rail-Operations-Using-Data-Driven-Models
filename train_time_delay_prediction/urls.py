"""train_time_delay_prediction URL Configuration
...
from train_time_delay_prediction import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Train_Delay_Type/$', remoteuser.Predict_Train_Delay_Type, name="Predict_Train_Delay_Type"),
    ...
    url(r'^View_Train_Delay_Detection_Ratio/$', serviceprovider.View_Train_Delay_Detection_Ratio, name="View_Train_Delay_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Train_Time_Delay/$', serviceprovider.View_Prediction_Of_Train_Time_Delay, name="View_Prediction_Of_Train_Time_Delay"),
